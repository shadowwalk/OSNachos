...
//D					else /* update the requirement in food to be cooked database	*/
//D						foodToBeCookedData.sixBurger++;
				}
				/* if 3$burger is ordered	*/
				if(custData[custIndex].threeBurger == 1){
					/* if 3$burger is ready	*/
...
//D					else  /* update the requirement in food to be cooked database	*/
//D						foodToBeCookedData.threeBurger++;
				}
				/* if vegburger is ordered	*/
				if(custData[custIndex].vegBurger == 1){
					/* if vegburger is ready	*/
...
//D					else  /* update the requirement in food to be cooked database	*/
//D						foodToBeCookedData.vegBurger++;
				}
				/* if fries is ordered	*/
				if(custData[custIndex].fries == 1){
					/* if fries is ready	*/
